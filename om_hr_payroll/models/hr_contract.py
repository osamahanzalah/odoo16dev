...
class HrContract(models.Model):
    ...
    wage = fields.Monetary('Gross', required=True, tracking=True, help="Employee's monthly gross wage.")
    hra = fields.Monetary(string='Basic', help="Basic.")
    travel_allowance = fields.Monetary(string="Travel Allowance", help="Travel allowance")
    da = fields.Monetary(string="Social Insurance", help="Social Insurance")
    meal_allowance = fields.Monetary(string="Reward", help="Reward")
